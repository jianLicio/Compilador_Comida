...
public class Comida implements ComidaConstants {
  ...
  final public void inteiro() throws ParseException {
    jj_consume_token(NUMERO);
}

  final public void flutuante() throws ParseException {
    inteiro();
    label_1:
    while (true) {
  ...
  final public void arroz() throws ParseException {
    jj_consume_token(ARROZ);
}

  final public void feijao() throws ParseException {
    jj_consume_token(FEIJAO);
}

  final public void pao() throws ParseException {
    jj_consume_token(PAO);
}

  final public void salame() throws ParseException {
    jj_consume_token(SALAME);
}

  final public void pimenta() throws ParseException {
    jj_consume_token(PIMENTA);
}

  final public void linguica() throws ParseException {
  ...
  final public void enter() throws ParseException {
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case ENTER:{
  ...
  final public void abreParenteses() throws ParseException {
    jj_consume_token(ABRE_PARENTESES);
}

  final public void grelha() throws ParseException {
    jj_consume_token(GRELHA);
}

  final public void churrasqueira() throws ParseException {
    jj_consume_token(CHURRASQUEIRA);
}

  final public void fechaParenteses() throws ParseException {
    jj_consume_token(FECHA_PARENTESES);
}

  final public void abreChave() throws ParseException {
    enter();
    jj_consume_token(ABRE_CHAVE);
    enter();
}

  final public void fechaChave() throws ParseException {
    enter();
    jj_consume_token(FECHA_CHAVE);
    enter();
}

  final public void virgula() throws ParseException {
    jj_consume_token(VIRGULA);
}

  final public void pontoVirgula() throws ParseException {
    jj_consume_token(PONTO_VIRGULA);
}

  final public void igual() throws ParseException {
    jj_consume_token(IGUAL);
}

  final public void diferente() throws ParseException {
    jj_consume_token(DIFERENTE);
}

  final public void igualLogico() throws ParseException {
    jj_consume_token(IGUAL_LOGICO);
}

  final public void menor() throws ParseException {
    jj_consume_token(MENOR);
}

  final public void maior() throws ParseException {
    jj_consume_token(MAIOR);
}

  final public void menorIgual() throws ParseException {
    jj_consume_token(MENOR_IGUAL);
}

  final public void maiorIgual() throws ParseException {
    jj_consume_token(MAIOR_IGUAL);
}

  final public void igual_logico() throws ParseException {
    jj_consume_token(IGUAL_LOGICO);
}

  final public void delimitaTexto() throws ParseException {
    jj_consume_token(DELIMITAR_TEXTO);
}

  final public void seta() throws ParseException {
    jj_consume_token(SETA);
}

  final public void mais() throws ParseException {
    jj_consume_token(PLUS);
}

  final public void menos() throws ParseException {
    jj_consume_token(MINUS);
}

  final public void multiplica() throws ParseException {
  ...
  final public void exponencial() throws ParseException {
    jj_consume_token(EXP);
}

  final public void falso() throws ParseException {
    jj_consume_token(FALSO);
}

  final public void verdadeiro() throws ParseException {
    jj_consume_token(VERDADEIRO);
}

  final public void ta_na_mesa() throws ParseException {
  ...
  final public void letra() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  final public void letraMinuscula() throws ParseException {
    jj_consume_token(LETRA_MINUSCULA);
}

  final public void letraMaiuscula() throws ParseException {
    jj_consume_token(LETRA_MAIUSCULA);
}

  final public void ponto() throws ParseException {
    jj_consume_token(PONTO);
}

  final public void doisPontos() throws ParseException {
  ...
  final public void caractereEspecial() throws ParseException {
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
System.err.println("ID -> " + e.getMessage());
  ...
  final public void termoTexto() throws ParseException {
    delimitaTexto();
    label_5:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
System.err.println("imprimir-> " + e.getMessage());
  ...
  final public void repetir() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case GRELHA:{
      grelha();
      doisPontos();
  ...
  public ComidaTokenManager token_source;
